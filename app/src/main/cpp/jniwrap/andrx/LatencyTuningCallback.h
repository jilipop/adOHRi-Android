...
#ifndef LATENCY_TUNING_CALLBACK_H
#define LATENCY_TUNING_CALLBACK_H
...
/**
 * This callback object extends the functionality of `DataCallback` by automatically
 ...
 * blocking.
 */
class LatencyTuningCallback: public DataCallback {
public:
    LatencyTuningCallback() : DataCallback() {
